...
public class CmdLineParser
{
	...
	public static abstract class Option
	{
		...
		{
			String s = shortForm != null && shortForm.length() > 0 ? "-"+shortForm  : "";
			String l = longForm != null ? "--" + longForm : "";
			if (l.length() > 0){
				if (s.length() > 0) s += ", ";
				s += l;
			}
			String d = description.equals("") ? "" : "\t: " +description;
			if (d.length() > 0){
				if (d.length() > 0) d += ", ";
				s += d;
			}
	...
	public final Object getOptionValue2(String longform, Object def)
	{
	...
	{
		return getOptionValue(o.longForm(), def);
	}
	...
	{
		List<String> sortedKeys = getSortedKeys(getOptions());
		for(String k : sortedKeys)
		{
			Object object = getOptions().get(k);
